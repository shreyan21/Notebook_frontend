...
function UserProfile(props) {
    ...
    const removeuser=async(event)=>{
        ...
        await fetch('https://notebookbackend.netlify.app/auth/remove',{method:'DELETE',headers:{'Content-Type':'application/json','Authorization':`${token}`},body:JSON.stringify({id:data.user.id})})
        localStorage.clear()
        setToken(null)
     navigate('/')
    }
