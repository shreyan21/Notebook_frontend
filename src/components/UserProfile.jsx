...
function UserProfile(props) {
    ...
    const removeuser = async (event) => {
        event.preventDefault()
        await fetch('https://notebook-backend-nine.vercel.app/auth/remove', { method: 'DELETE', headers: { 'Content-Type': 'application/json', 'Authorization': `${token}` }, body: JSON.stringify({ id: data.user.id }) })
        localStorage.clear()
        setToken(null)
        navigate('/')
    }
