...
const ViewNotes = (props) => {
    ...
    const handleDelete = async (id) => {
        try {
            await fetch(`https://notebookbackend.netlify.app/deleteNotes/${id}`, { method: "DELETE", headers: { 'Content-Type': 'Application/json', 'Authorization': `${token}` } })
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const res = await fetch('https://notebookbackend.netlify.app/notes/fetchNotes', { method: "GET", headers: { 'Content-Type': 'Application/json', 'Authorization': `${token}` } })
                if (!res.ok) {
