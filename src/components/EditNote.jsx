...
const EditNote = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const result=await fetch(`https://notebook-backend-virid.vercel.app/notes/updateNotes/${id}`, { method: 'PUT', headers: { 'Content-Type': 'Application/json', 'Authorization': `${JSON.parse(localStorage.getItem('token'))}` }, body: JSON.stringify({ title, description, tag }) })
